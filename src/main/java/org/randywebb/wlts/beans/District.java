...
public class District extends AbstractBean {
    ...
    */
    public void setCompanionships(List<Companionship> companionshipsToSet) {
        ...
        addCompanionships(companionshipsToSet);
    }

    /**
        @param companionshipsToAdd Adds companionships to any existing companionships
    */
    public void addCompanionships(List<Companionship> companionshipsToAdd) {
        companionships.addAll(companionshipsToAdd);
    }
